...
async function main() {
  ...
  const upsertListing = db.prepare(`
    INSERT INTO listings (
      slug, title, category_id, year, make, model, trim, condition,
      mileage, vin, engine_hp, engine_type, transmission, drivetrain,
      fuel_type, body_style, exterior_color, interior_color, doors, seats,
      title_status, stock_number, description, highlights, specs,
      location_city, location_state, location_zip,
      buy_now_price, starting_bid, reserve_price, bid_increment,
      status, quantity, keep_selling, is_featured, current_bid
    ) VALUES (
      @slug, @title, @category_id, @year, @make, @model, @trim, 'used',
      @mileage, @vin, @engine_hp, @engine_type, @transmission, @drivetrain,
      @fuel_type, @body_style, @exterior_color, @interior_color, @doors, @seats,
      @title_status, @stock_number, @description, @highlights, @specs,
      @city, @state, @zip,
    ...
    ON CONFLICT (slug) DO UPDATE SET
      ...
      trim = excluded.trim, mileage = excluded.mileage, vin = excluded.vin,
      ...
      fuel_type = excluded.fuel_type, body_style = excluded.body_style,
      exterior_color = excluded.exterior_color, interior_color = excluded.interior_color,
      doors = excluded.doors, seats = excluded.seats,
      title_status = excluded.title_status, stock_number = excluded.stock_number,
  ...
  for (const item of LISTINGS) {
    upsertListing.run({
      ...
      title_status: item.title_status || 'Clean',
