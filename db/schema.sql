-- ===========================================================================
--  AutoBlock Auctions -- database schema
...
CREATE TABLE IF NOT EXISTS listings (
  ...
  engine_hp        INTEGER,
  engine_type      TEXT,             -- e.g. "6.7L Cummins Turbo Diesel I6"
  transmission     TEXT,             -- e.g. "6-speed automatic"
  drivetrain       TEXT,             -- FWD / RWD / AWD / 4WD
  fuel_type        TEXT,             -- Gasoline / Diesel / Hybrid / Electric
  body_style       TEXT,             -- Sedan / SUV / Crew Cab / Coupe
  exterior_color   TEXT,
  interior_color   TEXT,
  doors            INTEGER,
  seats            INTEGER,
