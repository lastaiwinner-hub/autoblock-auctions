...
Online auction and instant-buy platform for cars, trucks, SUVs and motorcycles.
...
Its sister project, **IronHaul Auctions** (`../ironhaul-auctions`), is the same
engine adapted for excavators and heavy equipment.
...
| Role | Email | Password |
|---|---|---|
| Administrator | `admin@autoblock-auctions.com` | `ChangeMe!2026` |
...
This matters more here than on the equipment side: dealers routinely hold
several identical trim/colour combinations, and a won auction should not take
...
db/
  ...
  fetch-images.js   downloads freely-licensed seed photography, ranked by make/year
src/
...
- [ ] Confirm your dealer licensing, odometer disclosure and Buyers Guide
      obligations — see the legal section of DEPLOYMENT.md
