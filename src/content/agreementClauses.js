  ...
  return [
    ...
    },
    {
      ...
      table: [
        ...
        ['Odometer', a.item_meter || 'On request'],
        ['Engine HP', a.item_engine_hp || '—'],
        ['Vehicle Identification Number (VIN)', a.item_vin || 'On request'],
    ...
    },
    {
      ...
      paragraphs: [
        `<strong>${a.seller_name}</strong> certifies that it is the lawful owner of the above-described Vehicle and that it is free of all encumbrances and any and all legal claims. Parties agree to sign all documents necessary to transfer title and ownership of the Vehicle from the Seller to the Buyer within ${B.terms.inspectionDays} days of the date of this Agreement.`,
        'The Seller shall provide the title or equivalent ownership document for the Vehicle. The Buyer shall be liable for all administrative costs relating to titling and registration of the Vehicle in his/her name, together with any state inspection or emissions certificate required in the Buyer&rsquo;s jurisdiction.',
      ],
    },
    {
      n: 5,
    ...
    {
      n: 6,
      heading: 'Vehicle Buy Back Guarantee',
      paragraphs: [
        ...
        `The purchased vehicle must not be altered, repaired, resold or used commercially, and must not be driven beyond what is required to verify its condition — not more than <strong>${B.terms.maxInspectionMiles} miles</strong> from the odometer reading at time of sale. In the event of a return, the Buyer is NOT responsible for freight and handling charges. In the event of a return, the Seller agrees to refund the Buyer, in full, within ${B.terms.refundWindowHours} hours.`,
        `If the Buyer decides to return the Vehicle, the Seller (<strong>${B.legalName}</strong>) agrees to collect the item, covering all the related costs.`,
      ],
    },
    {
      n: 7,
