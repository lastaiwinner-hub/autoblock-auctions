...
module.exports = (B) => [
  ...
  },
  {
    ...
    paragraphs: [
      'We hold physical inventory and may hold multiple vehicles of the same specification. Where stock remains after a winning bid is declared, we may open a further auction cycle for the same listing and continue to offer the item at its Buy Now price.',
  ...
  },
  {
    ...
    paragraphs: [
      `The purchase price is the hammer price or Buy Now price as applicable. There is no buyer premium. Delivery is charged separately and is estimated at ${B.terms.currencySymbol}${B.terms.deliveryRatePerMile.toFixed(2)} per mile from our lot, confirmed in writing before payment.`,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Customer collection from our lot is not available. You must ensure the delivery address is accessible to a vehicle transporter and that someone authorised is present to receive and sign for the item. Where a site cannot accept a full-size transporter we will agree a nearby meeting point.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `During the inspection period the vehicle must not be altered, repaired, resold or used commercially. Use is limited to verifying condition and must not exceed ${B.terms.maxInspectionMiles} miles beyond the odometer reading at time of sale.`,
  ...
  {
    heading: '11. Title and ownership documents',
    paragraphs: [
      'Every vehicle is sold with its title or equivalent ownership document. The title status shown on each listing (clean, rebuilt or salvage) is disclosed before you bid and is repeated on your purchase agreement.',
      'Title documents are released once payment has cleared in full, and are sent by tracked mail or handed over on delivery. Titling, registration, road tax and any state inspection or emissions certificate in your jurisdiction are your responsibility and at your cost.',
      'Odometer readings are recorded as displayed at the time of listing and are disclosed in accordance with applicable federal and state odometer disclosure requirements.',
    ],
  },
  {
    heading: '12. Condition and "as is" basis',
    paragraphs: [
      'Vehicles are inspected and serviced before listing, and we describe them as accurately as we can, including known faults, accident history where disclosed, and the odometer reading.',
  ...
  {
    heading: '13. Non-payment and default',
    paragraphs: [
