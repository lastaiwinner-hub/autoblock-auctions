...
router.get('/inventory', (req, res) => {
  ...
  const filters = {
    ...
    mileageMax: req.query.mileage_max || '',
    fuelType: req.query.fuel_type || '',
    transmission: req.query.transmission || '',
    titleStatus: req.query.title_status || '',
  ...
  res.render('pages/inventory', {
    ...
    metaDescription: activeCategory
      ...
      : `Browse ${total} vehicles available now. Filter by make, model, year, mileage and price.`,
